                                        ...
                                        <div class="col-md-4">
                                            <div class="single-product-items">
                                                <div class="product-item-image">
                                                    <a href="#">
                                                        <img src="<?php echo e($product->image_name); ?>" alt="Product"
                                                        height="320px">
                                                    </a>
                                                ...
                                                <div class="product-item-content text-center mt-30">
                                                    <h5 class="product-title"><a href="#"><?php echo e($product->name); ?></a></h5>
                                                    <ul class="rating">
                                                    ...
                                                    <span class="regular-price"><?php echo e($product->sale_price); ?></span>
                                                    <span class="discount-price"><?php echo e($product->price); ?></span>
                                                    
                                                    <add-to-cart-button product-id="<?php echo e($product->id); ?>"
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/manu/Desktop/shop/resources/views/product.blade.php ENDPATH**/ ?>